...
### Pitta（個別募集ページ）で確認できる面談条件（2026-04-16 取得）
...
- 無料キャリアセッションの **回数/成果物/範囲（どこまで無料か）** は、少なくとも公式トップ・利用規約・About では具体に確認できない（2026-04-16時点）。
- 所要時間は、Pittaの個別募集ページで **45min** を確認できた一方、公式一次では明示を確認できていない（2026-04-16時点）。
- 所属コンサルタントの **人数、採用要件、方法論、レビュー/監修体制** の具体は公式一次情報で未確認（2026-04-16時点）。
